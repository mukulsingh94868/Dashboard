...
export const deleteTodo = async (id) => {
  try {
    ...
    const response = await axios.delete(`${API_NEW}/todo/deleteTodo/${id}`, {
      headers: {
        Authorization: `${token}`,
      },
    });
...
export const getCalenderEventByUserId = async (userId) => {
  try {
    ...
    const response = await axios.get(`${API_NEW}/calender/events/${userId}`, {
      headers: {
        Authorization: `${token}`,
      },
    });
...
export const getProductCategory = async (cat) => {
  try {
    const response = await axios.get(`${API_NEW}/categoryProduct/${cat}`);
